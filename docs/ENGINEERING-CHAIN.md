...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Composable stages, backpressure and slow-dependency isolation and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_http_properties.py](../tests/test_http_properties.py) | Contract-focused validation at the repository boundary |
